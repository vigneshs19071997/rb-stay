export const INDIA_DISTRICTS: Record<string, string[]> = {
  ...
  "Madhya Pradesh": [
    ...
    "Morena","Narmadapuram","Narsinghpur","Neemuch","Niwari","Panna","Raisen",
  ...
  "Rajasthan": [
    ...
    "Deeg","Dhaulpur","Didwana-Kuchaman","Dudu","Dungarpur","Gangapur City",
  ...
  "Uttar Pradesh": [
    ...
    "Lakhimpur Kheri","Lalitpur","Lucknow","Mahoba","Maharajganj","Mainpuri",
...
export const INDIA_STATES = Object.keys(INDIA_DISTRICTS).sort((a, b) => a.localeCompare(b));
